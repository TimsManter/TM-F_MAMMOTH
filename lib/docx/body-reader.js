...
function BodyReader(options) {
    ...
    function readCommentBound(element, edge) {
        return elementResult(documents.commentBound({
            commentId: element.attributes["w:id"],
            edge: edge
        }));
    }
    ...
    function readChange(element, type) {
        return elementResult(documents.change({
            changeId: element.attributes["w:id"],
            authorName: element.attributes["w:author"],
            changeType: type,
            children: readXmlElements(element.children).value
        }));
    }
    ...
    var xmlElementReaders = {
        ...
        "w:commentRangeStart": function(element) {
            return readCommentBound(element, "start");
        },
        "w:commentRangeEnd": function(element) {
            return readCommentBound(element, "end");
        },
        ...
        "w:ins": function(element) {
            return readChange(element, "ins");
        },
        "w:del": function(element) {
            return readChange(element, "del");
        },
